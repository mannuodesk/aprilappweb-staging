...
var Specific = (function () {
    ...
    Specific.prototype.saveBlock = function (Id) {
        ...
        if (blockName != "" && blockName !== undefined && this.addBlockFlag == false) {
    ...
    Specific.prototype.toggleDivs = function (val) {
        ...
        if (val == 1) {
            ...
            if (this.GroupText != "" && this.addGroupFlag == false) {
    ...
    Specific.prototype.deleteGalleryCardBtn = function (cardId, indexId) {
        var _this = this;
