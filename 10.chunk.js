...
var Specific = (function () {
    ...
    Specific.prototype.saveBlock = function (Id) {
        ...
        if (this.blockName != "" && this.blockName !== undefined && this.addBlockFlag == false) {
