...
module.exports = "<ol class=\"breadcrumb\">\r\n    <li class=\"breadcrumb-item\">YOU ARE HERE</li>\r\n    <li class=\"breadcrumb-item active\">Notification</li>\r\n</ol>\r\n<h1 class=\"page-title\">Send Notifications</h1>\r\n\r\n<section>\r\n    <div class=\"row\">\r\n        <div class=\"col-md-6\">\r\n            <div class=\"row\">\r\n                <div class=\"col-lg-12 col-xs-12\">\r\n                    <textarea rows=\"4\" class=\"form-control\" [(ngModel)]=\"NotificationText\" placeholder=\"Enter Notification text here ...\" id=\"default-textarea\"></textarea>\r\n                </div>\r\n            </div>\r\n            <br/>\r\n            <div class=\"row\">\r\n                <div class=\"offset-lg-4 col-lg-4\">\r\n                    <button class=\"btn btn-block btn-success\" (click)=\"addNotification()\">\r\n            Send Notification\r\n        </button>\r\n                </div>\r\n            </div>\r\n        </div>\r\n        <div class=\"col-md-6\">\r\n            <div class=\"row notification-list\" *ngFor=\"let notificationUser of notificationArray\">\r\n                <span (click)=\"deleteNotification(notificationUser._id)\" class=\"delete-notification-btn\"><i class=\"fa fa-times\" aria-hidden=\"true\"></i></span>\r\n                {{notificationUser._notificationId.text}}\r\n            </div>\r\n        </div>\r\n    </div>\r\n</section>\r\n<modal #myModal>\r\n  <modal-header>\r\n    <h4 class=\"modal-title text-xs-center fw-bold mt\" id=\"myModalLabel18\">Confirmation</h4>\r\n    <p class=\"text-xs-center fs-mini text-muted mt-sm\">\r\n      Do you really want to remove this Notification?\r\n    </p>\r\n  </modal-header>\r\n  <modal-content>\r\n    <form>\r\n      <div class=\"row\">\r\n        <div class=\"col-lg-6 col-xs-12\">\r\n          <button type=\"button\" class=\"btn btn-success pull-right\" (click)=\"deleteNotificationConfirm();myModal.close()\">Yes</button>\r\n        </div>\r\n        <div class=\"col-lg-6 col-xs-12\">\r\n          <button type=\"button\" class=\"btn btn-danger pull-left\" (click)=\"myModal.close()\">No</button>\r\n        </div>\r\n      </div>\r\n    </form>\r\n  </modal-content>\r\n</modal>"
...
var NotificationService_1 = __webpack_require__("./src/app/services/NotificationService.ts");
var Quill = __webpack_require__("./node_modules/quill/dist/quill.js");
var Notification = (function () {
    function Notification(_notificationService) {
    ...
    Notification.prototype.populateNotifications = function () {
        var _this = this;
        this._notificationService.getNotification(sessionStorage.getItem('userId')).subscribe(function (a) {
            if (a.code == 200) {
                _this.notificationArray = a.data;
            }
        });
    };
    ...
    Notification.prototype.deleteNotification = function (_notificationUserId) {
        this._notificationUserId = _notificationUserId;
        this.modalComponent.open();
    };
    Notification.prototype.deleteNotificationConfirm = function () {
        var _this = this;
        this._notificationService.deleteNotification(this._notificationUserId).subscribe(function (a) {
            if (a.code == 200) {
                _this.populateNotifications();
            }
        });
    ...
    ], Notification.prototype, "modalComponent", void 0);
    Notification = __decorate([
        ...
        __metadata('design:paramtypes', [(typeof (_b = typeof NotificationService_1.NotificationService !== 'undefined' && NotificationService_1.NotificationService) === 'function' && _b) || Object])
    ], Notification);
    return Notification;
    var _a, _b;
}());
...
exports.routes = [
    { path: '', component: notification_component_1.Notification, pathMatch: 'full' }
];
var NotificationModule = (function () {
    function NotificationModule() {
    }
    NotificationModule.routes = exports.routes;
    NotificationModule = __decorate([
        core_1.NgModule({
            declarations: [
                // Components / Directives/ Pipes
                notification_component_1.Notification
            ],
            imports: [
                common_1.CommonModule,
                forms_1.FormsModule,
