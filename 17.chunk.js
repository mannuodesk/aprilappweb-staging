...
var Faqs = (function () {
    ...
    Faqs.prototype.deleteDirectory = function (Id) {
        var _this = this;
        this._miscService.deleteFaqs(this.deleteID).subscribe(function (a) {
            if (a.code == 200) {
                _this.addDirectoryContent = "";
                _this.directoryTitle = "";
                _this.populate();
    ...
    Faqs.prototype.checkErrors = function () {
    ...
    Faqs.prototype.updateTitle = function (Id) {
        var _this = this;
        var title = jQuery('#directoryTitle' + Id).val();
        if (title != "" && title !== undefined && title.replace(/\s/g, '').length != 0) {
            this._miscService.updateFAQTitle(Id, title).subscribe(function (a) {
                if (a.code == 200) {
    ...
    ], Faqs.prototype, "saveModal", void 0);
    Faqs = __decorate([
        core_1.Component({
            selector: '[faqs]',
