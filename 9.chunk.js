...
var Generic = (function () {
        ...
        jQuery(function () {
            jQuery('.mainlist').sortable({
                ...
                update: function (e, ui) {
                    ...
                    jQuery.post("https://aprilappserver.azurewebsites.net/groups/setOrderOfGroups", {
                        oldIndex: oldIndex,
                        newIndex: newIndex,
                        groupId: groupId,
                        type: 'Generic'
            ...
            jQuery('.sublist').sortable({
                ...
                update: function (e, ui) {
                    ...
                    jQuery.post("https://aprilappserver.azurewebsites.net/blocks/sortBlock", {
                        oldIndex: oldIndex,
                        newIndex: newIndex,
                        blockId: blockId,
                        groupId: ul[0].id
    ...
    Generic = __decorate([
        ...
        __metadata('design:paramtypes', [(typeof (_m = typeof BotTrainingService_1.BotTrainingService !== 'undefined' && BotTrainingService_1.BotTrainingService) === 'function' && _m) || Object, (typeof (_o = typeof core_1.ElementRef !== 'undefined' && core_1.ElementRef) === 'function' && _o) || Object])
    ], Generic);
    return Generic;
...
var ArticleCard = (function (_super) {
    ...
    function ArticleCard(_titleText, _articleText, _pictureUrl) {
        _super.call(this);
