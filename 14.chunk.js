...
var Directory = (function () {
    ...
    Directory.prototype.onReady = function (event, i, responseMessageId) {
        //alert(i);
    ...
    Directory.prototype.onBlur = function (event, directoryId, i) {
        var text = this.ckeditorContent[i];
        this._miscService.updateDirectory(directoryId, this.ckeditorContent[i]).subscribe(function (a) {
            if (a.code == 200) {
            }
        });
    };
    Directory.prototype.onEditorCreated = function (quill, i, responseMessageId) {
    };
    Directory.prototype.logChange = function ($event) {
        console.log($event);
    };
    ...
    Directory.prototype.deleteDirectory = function () {
        var _this = this;
        this._miscService.deleteDirectory(this.deleteId).subscribe(function (a) {
            if (a.code == 200) {
                _this.addDirectoryContent = "";
                _this.directoryTitle = "";
                _this._miscService.getAlldirectory().subscribe(function (a) {
    ...
    Directory.prototype.checkErrors = function () {
        if (this.directoryTitle != "" && this.directoryTitle.replace(/\s/g, '').length != 0) {
            this.saveModal.open();
        }
        else {
            jQuery('#tooltip-enabled').addClass('modalError');
    ...
    ], Directory.prototype, "saveModal", void 0);
    Directory = __decorate([
        ...
        __metadata('design:paramtypes', [(typeof (_b = typeof MiscServices_1.MiscServices !== 'undefined' && MiscServices_1.MiscServices) === 'function' && _b) || Object])
    ], Directory);
    return Directory;
    var _a, _b;
}());
...
var directory_component_1 = __webpack_require__("./src/app/directory/directory.component.ts");
...
exports.routes = [
    { path: '', component: directory_component_1.Directory, pathMatch: 'full' }
];
var DirectoryModule = (function () {
    function DirectoryModule() {
    }
    DirectoryModule.routes = exports.routes;
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.default = DirectoryModule;
...
/***/ "./src/app/services/MiscServices.ts":
/***/ function(module, exports, __webpack_require__) {
