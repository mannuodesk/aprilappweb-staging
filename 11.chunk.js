...
var Specific = (function () {
    ...
    Specific.prototype.mouseEnterTCAB = function (id) {
        jQuery('#textCardAddBtn' + id).show();
    };
    Specific.prototype.mouseLeaveTCAB = function (id) {
        jQuery('#textCardAddBtn' + id).hide();
    };
