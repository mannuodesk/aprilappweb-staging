...
var Specific = (function () {
    ...
    Specific.prototype.editQuickReplyBtns = function () {
        ...
        if (this.EditQuickReplyName != "" && jQuery('#editQR-select').val() != "" && specialCharacterFlag == false) {
    ...
    Specific.prototype.editButtonPost = function (val) {
        ...
        if (val == 1) {
            ...
            if (this.EditButtonBlock != "" && this.EditButtonName != "") {
                if (this.editBtnResponseMessageType == 'text') {
            ...
            if (this.EditButtonUrl != "" && this.EditButtonName != "") {
                if (this.editBtnResponseMessageType == 'text') {
                    obj.buttonname = this.EditButtonName;
