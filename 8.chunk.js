...
var Specific = (function () {
    ...
    Specific.prototype.updateTitleRandomTextCard = function (responseMessageId, i) {
        var _this = this;
        console.log(jQuery('#textCardTitle' + responseMessageId + i).val());
    ...
    Specific.prototype.submitQuickReplyBtns = function () {
        ...
        console.log(this.QuickReplyButtonName);
        console.log(this.QuickReplyButtonBlock);
        var count = 0;
        jQuery('#simple-select').removeClass('modalError');
        jQuery('#buttonNameQR').removeClass('modalError');
        var counts = jQuery('.qrbtns').length;
        if (this.QuickReplyButtonName != "" && this.QuickReplyButtonBlock != "") {
    ...
    Specific.prototype.saveBlock = function (Id) {
        ...
        if (blockName != "" && blockName !== undefined && this.addBlockFlag == false && blockName.replace(/\s/g, '').length != 0) {
    ...
    Specific.prototype.toggleDivs = function (val) {
        ...
        if (val == 1) {
            ...
            if (this.GroupText != "" && this.addGroupFlag == false && this.GroupText.replace(/\s/g, '').length != 0) {
    ...
    Specific.prototype.characterCount = function (cardId, Id) {
        ...
        console.log(jQuery('#textCardTitle' + cardId + Id));
    };
    ...
    Specific.prototype.editBlockName = function (Id) {
        var _this = this;
        console.log(jQuery('#blockNameChange').val());
    ...
    Specific = __decorate([
        ...
        __metadata('design:paramtypes', [(typeof (_k = typeof BotTrainingService_1.BotTrainingService !== 'undefined' && BotTrainingService_1.BotTrainingService) === 'function' && _k) || Object, (typeof (_l = typeof core_1.ElementRef !== 'undefined' && core_1.ElementRef) === 'function' && _l) || Object])
    ], Specific);
    return Specific;
