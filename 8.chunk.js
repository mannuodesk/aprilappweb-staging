    ...
    Specific.prototype.deleteResponseMessage = function () {
        ...
        this._botTrainingService.deleteResponseMessage(this.responseMessageId).subscribe(function (a) {
            for (var i = 0; i < _this.cardArray.length; i++) {
                ...
                if (obj._id == _this.responseMessageId) {
