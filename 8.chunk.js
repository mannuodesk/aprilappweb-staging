...
var Generic = (function () {
    ...
    Generic.prototype.ngOnInit = function () {
        jQuery("body").click(function (e) {
            if (e.target.className !== "blockNameDiv" && e.target.className !== "blockNameDiv form-control") {
            ...
            for (var i = 0; i < this.cardArray.length; i++) {
                if (this.cardArray[i]._id == responseMessageId) {
                    for (var j = 0; j < this.cardArray[i].data.length; j++) {
                        if (this.cardArray[i].data[j].indexId == addBtnId) {
                            for (var k = 0; k < this.cardArray[i].data[j].cardAddButton.length; k++) {
                                if (this.cardArray[i].data[j].cardAddButton[k]._addButtonId == gallerCardAddBtnId) {
        ...
        if (val == 1) {
            ...
            if (this.editBtnResponseMessageType == 'text') {
                ...
                for (var i = 0; i < this.cardArray.length; i++) {
                    if (this.cardArray[i]._id == this.editBtnResponseMessageId) {
                        for (var j = 0; j < this.cardArray[i].data.length; j++) {
                            if (this.cardArray[i].data[j].indexId == this.editBtnId) {
                                for (var k = 0; k < this.cardArray[i].data[j].cardAddButton.length; k++) {
                                    if (this.cardArray[i].data[j].cardAddButton[k]._addButtonId == this.gallerCardAddBtnId) {
            ...
            if (this.EditButtonBlock != "" && this.EditButtonName != "") {
                if (this.editBtnResponseMessageType == 'text') {
                    ...
                    jQuery('#buttonName').removeClass('modalError');
                    jQuery('#simple-select').removeClass('modalError');
                    this._botTrainingService.updateGalleryAddBtns(this.editBtnResponseMessageId, this.gallerCardAddBtnId, obj, 'block', this.editBtnResponseMessageType).subscribe(function (a) {
                        if (a.code == 200) {
                            _this.AddButtonName = "";
                            _this.AddButtonBlock = "";
                            _this.blockDetail(_this.popBlock._id);
            ...
            if (this.EditButtonUrl != "" && this.EditButtonName != "") {
                if (this.editBtnResponseMessageType == 'text') {
                    ...
                    jQuery('#buttonName').removeClass('modalError');
                    jQuery('#simple-select').removeClass('modalError');
                    this._botTrainingService.updateGalleryAddBtns(this.editBtnResponseMessageId, this.gallerCardAddBtnId, obj, 'url', this.editBtnResponseMessageType).subscribe(function (a) {
                        if (a.code == 200) {
                            _this.AddButtonName = "";
                            _this.AddButtonBlock = "";
                            _this.blockDetail(_this.popBlock._id);
