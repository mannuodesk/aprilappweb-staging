...
var ArticleCard = (function (_super) {
    ...
    function ArticleCard(_titleText, _articleText, _pictureUrl, _indexId) {
        _super.call(this);
    ...
    ArticleCard.prototype.GetPictureUrl = function () { return this.pictureUrl; };
    ArticleCard.prototype.GetArticleText = function () { return this.articleText; };
    ArticleCard.prototype.GetIndexId = function () { return this.indexId; };
    return ArticleCard;
}(Serializable));
...
/***/ "./src/app/models/BlockGroupsModel.ts":
/***/ function(module, exports) {
...
exports.Serializable = Serializable;
var BlockGroupsModel = (function (_super) {
    __extends(BlockGroupsModel, _super);
    function BlockGroupsModel(group, blocks) {
        _super.call(this);
        this.group = group;
        this.blocks = blocks;
    }
    BlockGroupsModel.prototype.GetGroup = function () { return this.group; };
    BlockGroupsModel.prototype.GetBlocks = function () { return this.blocks; };
    return BlockGroupsModel;
}(Serializable));
exports.BlockGroupsModel = BlockGroupsModel;
...
module.exports = "<ol class=\"breadcrumb\">\r\n  <li class=\"breadcrumb-item\">YOU ARE HERE</li>\r\n  <li class=\"breadcrumb-item active\">Specific Groups and Topics</li>\r\n</ol>\r\n<h1 class=\"page-title\">Lists - <span class=\"fw-semi-bold\">Specific Groups for BOT</span></h1>\r\n<section class=\"widget widget2\" widget>\r\n  <header>\r\n    <h4>\r\n      Specific Group Lists\r\n    </h4>\r\n  </header>\r\n  <div class=\"widget-body\">\r\n    <div class=\"row\">\r\n      <div class=\"col-md-6 col-sm-12 col-lg-6 col-xs-12 divseparator\">\r\n\r\n\r\n        <ul id=\"list1\" class=\"mainlist\">\r\n          <li [ngClass]=\"{groupunsortable: blockGroups.group.isLocked == true}\" *ngFor=\"let blockGroups of blockGroupsModel\" class=\"hasItems\"\r\n            (mouseenter)=\"mouseEnterGroup(blockGroups.group._id)\" (mouseleave)=\"mouseLeaveGroup(blockGroups.group._id)\" id={{blockGroups.group._id}}>\r\n            <i class=\"fa fa-sort sorter\" [ngClass]=\"{sortercursor:blockGroups.group.isLocked != true}\"></i>\r\n            <a class=\"close\" *ngIf=\"blockGroups.group.isLocked == true\"><i class=\"fa fa-lock\" aria-hidden=\"true\"></i></a>\r\n            <a href=\"#\" id=\"gr{{blockGroups.group._id}}\" class=\"groupClose\" *ngIf=\"blockGroups.group.isLocked == false\" (click)=\"groupConfirmationModal.open();deleteGroupModal(blockGroups.group._id)\"\r\n              data-dismiss=\"alert\" aria-hidden=\"true\"><i class=\"fa fa-trash-o\" aria-hidden=\"true\"></i></a>\r\n            <div id=\"GroupNameDiv{{blockGroups.group._id}}\" class=\"GroupName\" (click)=\"changeGroupName(blockGroups.group._id)\">\r\n              {{blockGroups.group.name}}\r\n            </div>\r\n            <input id=\"groupNameChange{{blockGroups.group._id}}\" maxlength=\"60\" (change)=\"editGroupName(blockGroups.group._id)\" style=\"display: none\" type=\"text\" class=\"blockNameDiv form-control\" value=\"{{blockGroups.group.name}}\"/>\r\n<div id=\"editduplicateGroup{{blockGroups.group._id}}\" style=\"display:none\" class=\"form-group\">\r\n<div class=\"alert alert-danger alert-sm\">\r\n  <span class=\"fw-semi-bold\"></span> Group Name Should Be Unique.\r\n</div>\r\n</div>\r\n<ul id=\"{{blockGroups.group._id}}\" class=\"sublist\">\r\n  <li id=\"block{{block._id}}\" [ngClass]=\"{unsortable: blockGroups.group.isLocked == true}\" class=\"blockbtns\" *ngFor=\"let block of blockGroups.blocks\"\r\n    (mouseenter)=\"mouseEnterBlock(block._id)\" (mouseleave)=\"mouseLeaveBlock(block._id)\">\r\n    <a href=\"#\" id=\"closeBlock{{block._id}}\" class=\"closeBlock\" (click)=\"blockConfirmationModal.open();deleteBlockModal(block._id)\"\r\n      data-dismiss=\"alert\" *ngIf=\"blockGroups.group.isLocked == false\" aria-hidden=\"true\"><i class=\"fa fa-trash-o\" aria-hidden=\"true\"></i></a>\r\n    <div (click)=\"blockDetail(block._id)\">\r\n      <input id=\"hiddenBlockId\" type=\"hidden\" value=\"{{block._id}}\" />\r\n\r\n      <div class=\"blockBtnTxt\" *ngIf=\"block.name.length <= 30\">\r\n\r\n        <span class=\"blockIsCompleted\" *ngIf=\"block.isCompleted == false\"></span> {{block.name}}\r\n      </div>\r\n      <div class=\"blockBtnTxt\" *ngIf=\"block.name.length > 30\">\r\n\r\n        <span class=\"blockIsCompleted\" *ngIf=\"block.isCompleted == false\"></span> {{block.name.slice(0, 30)}}...\r\n      </div>\r\n    </div>\r\n  </li>\r\n\r\n  <li class=\"unsortable\" *ngIf=\"blockGroups.group.isLocked == false || blockGroups.group.type == Specific\">\r\n    <div class=\"addBlock{{blockGroups.group._id}} blockbtns addBlock2\" (click)=\"addBlock(blockGroups.group._id)\">\r\n      <i class=\"fa fa-plus\" aria-hidden=\"true\"></i> Add Block\r\n    </div>\r\n    <div class=\"saveBlock{{blockGroups.group._id}}\" style=\"display:none\">\r\n<div class=\"input-group\">\r\n  <input id=\"blockText{{blockGroups.group._id}}\" maxlength=\"50\" type=\"text\" class=\"form-control\" placeholder=\"Block Name\" />\r\n  <div class=\"input-group-btn\">\r\n    <button type=\"button\" (click)=\"saveBlock(blockGroups.group._id)\" class=\"btn\"><i class=\"fa fa-plus\"></i></button>\r\n    <button type=\"button\" (click)=\"refreshBlockTextBox(blockGroups.group._id)\" class=\"btn btn-primary\"><i class=\"fa fa-refresh\"></i></button>\r\n    <button type=\"button\" (click)=\"crossBlockTextBox(blockGroups.group._id)\" class=\"btn\"><i class=\"fa fa-times\"></i></button>\r\n  </div>\r\n</div>\r\n<div id=\"duplicateBlock{{blockGroups.group._id}}\" style=\"display:none;width: 75%;\" class=\"form-group\">\r\n<div class=\"alert alert-danger alert-sm\">\r\n  <span class=\"fw-semi-bold\"></span> Block Name Should Be Unique.\r\n</div>\r\n</div>\r\n<div id=\"specialCharactersGroup{{blockGroups.group._id}}\" style=\"display:none;width: 75%;\" class=\"form-group\">\r\n<div class=\"alert alert-danger alert-sm\">\r\n  <span class=\"fw-semi-bold\"></span> The string cannot contain ONLY special characters.\r\n</div>\r\n</div>\r\n</div>\r\n</li>\r\n</ul>\r\n\r\n</li>\r\n</ul>\r\n\r\n\r\n<div class=\"row GroupBtn\">\r\n  <p>\r\n    <button type=\"button\" (click)=\"toggleDivs(1)\" class=\"btn btn-info btn-block\">Add Specific Group</button>\r\n  </p>\r\n</div>\r\n<div class=\"row GroupForm\">\r\n  <div class=\"form-group\">\r\n    <div class=\"input-group\">\r\n      <input type=\"text\" [(ngModel)]=\"GroupText\" maxlength=\"60\" class=\"form-control\" id=\"bar\">\r\n      <div class=\"input-group-btn\">\r\n        <button type=\"button\" (click)=\"toggleDivs(2)\" class=\"btn\"><i class=\"fa fa-plus\"></i></button>\r\n        <button type=\"button\" (click)=\"refreshTextBox()\" class=\"btn btn-primary\"><i class=\"fa fa-refresh\"></i></button>\r\n        <button type=\"button\" (click)=\"toggleDivs(3)\" class=\"btn\"><i class=\"fa fa-times\"></i></button>\r\n      </div>\r\n    </div>\r\n  </div>\r\n</div>\r\n<div id=\"emptyGroup\" style=\"display:none\" class=\"form-group\">\r\n<div class=\"alert alert-danger alert-sm\">\r\n  <span class=\"fw-semi-bold\"></span> Please Enter Group Name.\r\n</div>\r\n</div>\r\n<div id=\"duplicateGroup\" style=\"display:none\" class=\"form-group\">\r\n<div class=\"alert alert-danger alert-sm\">\r\n  <span class=\"fw-semi-bold\"></span> Group Name Should Be Unique.\r\n</div>\r\n</div>\r\n<div id=\"specialCharactersGroup\" style=\"display:none\" class=\"form-group\">\r\n<div class=\"alert alert-danger alert-sm\">\r\n  <span class=\"fw-semi-bold\"></span> The string cannot contain ONLY special characters.\r\n</div>\r\n</div>\r\n</div>\r\n<div class=\"col-md-6 col-sm-12 col-lg-6 col-xs-12 rmdiv\" style=\"display:none\">\r\n<div class=\"row\">\r\n  <div class=\"col-md-12 col-lg-12 col-xs-12 col-sm-12\">\r\n    <h4 id=\"blockNameHeading\" class=\"blockNameDiv2\" (click)=\"changeBlockName()\">\r\n      {{popBlockName}}\r\n    </h4>\r\n    <input id=\"blockNameChange\" maxlength=\"50\" (change)=\"editBlockName(popBlockId)\" style=\"display: none\" type=\"text\" class=\"blockNameDiv form-control\" value=\"{{popBlockName}}\"/>\r\n<div id=\"editduplicateBlock{{popBlockId}}\" style=\"display:none;width: 75%;\" class=\"form-group\">\r\n<div class=\"alert alert-danger alert-sm\">\r\n  <span class=\"fw-semi-bold\"></span> Block Name Should Be Unique.\r\n</div>\r\n</div>\r\n<input id=\"popBlockIdd\" type=\"text\" value=\"{{popBlockId}}\" style=\"visibility:hidden\" />\r\n\r\n</div>\r\n</div>\r\n<ul class=\"list-group list-group-sortable2 mt-lg\">\r\n  <div *ngFor=\"let card of cardArray; let i = index\">\r\n    <li class=\"list-group-item\" (mouseenter)=\"mouseEnterRM(card._id)\" (mouseleave)=\"mouseLeaveRM(card._id)\" [ngClass]=\"{errorRM: card.isCompleted == false}\"\r\n      *ngIf=\"card.type == 'gallery'\" id=\"{{card._id}}\">\r\n      <a href=\"#\" id=\"closeCard{{card._id}}\" class=\"rmClose\" (click)=\"deleteResponseMessageModal(card._id);responseMessageConfirmationModal.open()\"\r\n        data-dismiss=\"alert\" aria-hidden=\"true\"><i class=\"fa fa-trash-o\" aria-hidden=\"true\"></i></a>\r\n      <div id=\"scroll{{card._id}}\" class=\"row table galleryHorizontalRow\">\r\n\r\n        <div class=\"galleryColumns galleryColumns{{card._id}}\" (mouseenter)=\"mouseEnterOneGalleryCard(galleryCard.indexId)\" (mouseleave)=\"mouseLeaveOneGalleryCard(galleryCard.indexId)\"\r\n          *ngFor=\"let galleryCard of card.data\">\r\n          <div class=\"card\">\r\n            <a href=\"#\" id=\"galleryRemoveBtn{{galleryCard.indexId}}\" class=\"randomGalleryTextClose\" (click)=\"delOneGalleryCard(card._id, galleryCard.indexId);galleryIndexModal.open()\"\r\n              data-dismiss=\"alert\" aria-hidden=\"true\"><i class=\"fa fa-trash-o\" aria-hidden=\"true\"></i></a>\r\n            <div class=\"image col-md-12 col-lg-12 col-xs-12 col-sm-1\">\r\n              <div class=\"image-inner\">\r\n                <input accept=\"image/*\" [(ngModel)]=\"galleryImageFile\" type=\"file\" id=\"galleryImage{{galleryCard.indexId}}\" (change)=\"populateGalleryImage($event, card._id, card._blockId, galleryCard.indexId)\"\r\n                  style=\"visibility: hidden;\" name=\"files\" title=\"Load File\" />\r\n<div id=\"galleryImageBtn{{galleryCard.indexId}}\" *ngIf=\"galleryCard.pictureUrl == ''\">\r\n  <button (click)=\"openGalleryImage(galleryCard.indexId)\" class=\"button-image col-xs-12 col-sm-12 btn-gray button-image--replace button-image--replace-gallery\">\r\n                            <span class=\"button-image__title\"><i class=\"fa fa-camera\" aria-hidden=\"true\"></i><br/>Upload Image</span>\r\n                          </button>\r\n</div>\r\n<div id=\"galleryImageDiv{{galleryCard.indexId}}\" *ngIf=\"galleryCard.pictureUrl != ''\" (mouseenter)=\"mouseEnterGI(galleryCard.indexId)\"\r\n  (mouseleave)=\"mouseLeaveGI(galleryCard.indexId)\" [ngStyle]=\"{ 'background-image': 'url(' + galleryCard.pictureUrl + ')'}\">\r\n  <div class=\"galleryImageBGDiv\" id=\"galleryImageChangeBtn{{galleryCard.indexId}}\">\r\n    <button class=\"btn\" (click)=\"openGalleryImage(galleryCard.indexId)\" style=\"background:transparent\">\r\n<i class=\"fa fa-camera\" aria-hidden=\"true\" style=\"color:white;font-size:24px;\"></i>\r\n</button>\r\n</div>\r\n</div>\r\n</div>\r\n</div>\r\n<div class=\"card-content col-md-12 col-lg-12 col-xs-12 col-sm-12\">\r\n  <div class=\"contenttitle\">\r\n    <textarea id=\"galleryCardTitle{{galleryCard.indexId}}\" maxlength=\"80\" placeholder=\"Title\" (change)=\"updateTitleGalleryCard(card._id, galleryCard.indexId)\">{{galleryCard.title}}</textarea>\r\n  </div>\r\n  <div class=\"contentbody contenttitle\">\r\n    <textarea id=\"galleryCardDescription{{galleryCard.indexId}}\" maxlength=\"80\" placeholder=\"Description\" (change)=\"updateDescriptionGalleryCard(card._id, galleryCard.indexId)\">{{galleryCard.description}}</textarea>\r\n  </div>\r\n  <div class=\"contenturl contenttitle\">\r\n    <input id=\"galleryCardUrl{{galleryCard.indexId}}\" value=\"{{galleryCard.url}}\" type=\"url\" placeholder=\"URL\" (change)=\"updateUrlGalleryCard(card._id, galleryCard.indexId)\"\r\n    />\r\n  </div>\r\n  <div *ngFor=\"let addButton of galleryCard.cardAddButton\" style=\"cursor: pointer\" (mouseenter)=\"mouseEnterGCAB(addButton._addButtonId)\" (mouseleave)=\"mouseLeaveGCAB(addButton._addButtonId)\">\r\n<a href=\"#\" id=\"galleryCardAddBtn{{addButton._addButtonId}}\" class=\"randomTextClose\" (click)=\"delAddButton(addButton._addButtonId, galleryCard.indexId, 'gallery');addBtnModal.open()\"\r\n  data-dismiss=\"alert\" aria-hidden=\"true\"><i class=\"fa fa-trash-o\" aria-hidden=\"true\"></i></a>\r\n<div class=\"addbuttonResultList\" (click)=\"editAddBtnModal.open();editButton(card._id, addButton._addButtonId, 'gallery','addButton', galleryCard.indexId)\">\r\n\r\n  <label>{{addButton.buttonname}}</label>\r\n  <p>{{addButton.urlblockname}}</p>\r\n</div>\r\n</div>\r\n<div class=\"addbutton\" *ngIf=\"galleryCard.cardAddButton.length != 3\" (click)=\"myModal.open();addButton(galleryCard.indexId, 'gallery', 'addButton')\">\r\n  <i class=\"fa fa-plus\" aria-hidden=\"true\"></i> Add Button\r\n</div>\r\n</div>\r\n<div class=\"top-buttons\">\r\n  <div class=\"button-remove\">\r\n    remove\r\n  </div>\r\n</div>\r\n</div>\r\n</div>\r\n<div class=\"galleryColumns galleryColumns{{card._id}}\">\r\n  <div class=\"card add\" (click)=\"addGalleryCard(card._id, card._blockId)\">\r\n\r\n  </div>\r\n</div>\r\n</div>\r\n</li>\r\n<li class=\"list-group-item\" (mouseenter)=\"mouseEnterRM(card._id)\" (mouseleave)=\"mouseLeaveRM(card._id)\" [ngClass]=\"{errorRM: card.isCompleted == false}\"\r\n  *ngIf=\"card.type == 'text'\" id=\"{{card._id}}\">\r\n  <a href=\"#\" id=\"closeCard{{card._id}}\" class=\"rmClose\" (click)=\"deleteResponseMessageModal(card._id);responseMessageConfirmationModal.open()\"\r\n    data-dismiss=\"alert\" aria-hidden=\"true\"><i class=\"fa fa-trash-o\" aria-hidden=\"true\"></i></a>\r\n\r\n  <div class=\"row\">\r\n    <div class=\"col-md-6 col-lg-6 col-xs-12 col-sm-12\">\r\n      <div class=\"card\">\r\n\r\n        <div class=\"card-content col-md-12 col-lg-12 col-xs-12 col-sm-12\">\r\n          <!--autogrow form-control transition-height-->\r\n          <div class=\"randomTextCard\" *ngFor=\"let text of card.data.randomText; let j = index\" (mouseenter)=\"mouseEnterRTC(card._id,text.indexId)\"\r\n            (mouseleave)=\"mouseLeaveRTC(card._id,text.indexId)\">\r\n            <a href=\"#\" (click)=\"deleteRandomText(text.indexId,card._id);randomTextCardModal.open()\" id=\"randText{{card._id}}{{text.indexId}}\"\r\n              class=\"randomTextClose\" *ngIf=\"j!=0\" data-dismiss=\"alert\" aria-hidden=\"true\"><i class=\"fa fa-trash-o\" aria-hidden=\"true\"></i></a>\r\n            <span id=\"textCardCount{{card._id}}{{text.indexId}}\" *ngIf=\"j!=0\" class=\"textcardCharCount\">{{320 - text.text.length}}  </span>\r\n            <!-- (keydown)=\"characterCount(card._id, text.indexId);dynamicHeight($event, card._id, text.indexId)\" -->\r\n\r\n            <textarea id=\"textCardTitle{{card._id}}{{text.indexId}}\" class=\"autogrow form-control transition-height\" rows=\"3\" autosize\r\n              *ngIf=\"j!=0\" maxlength=\"320\" placeholder=\"Title\" (keyup)=\"characterCount(card._id, text.indexId)\" (change)=\"updateTitleRandomTextCard(card._id, text.indexId)\">{{text.text}}</textarea>\r\n\r\n          </div>\r\n          <div class=\"addbutton\" style=\"border-radius: 0px;\" (click)=\"addTextRandom(card._id)\">\r\n<i class=\"fa fa-plus\" aria-hidden=\"true\"></i> Add Text Box\r\n</div>\r\n<div *ngFor=\"let addButton of card.data.cardAddButton\" style=\"cursor: pointer\" (mouseenter)=\"mouseEnterTCAB(card._id, addButton._addButtonId)\" (mouseleave)=\"mouseLeaveTCAB(card._id, addButton._addButtonId)\">\r\n<a href=\"#\" id=\"textCardAddBtn{{card._id}}{{addButton._addButtonId}}\" class=\"randomTextClose\" (click)=\"delAddButton(addButton._addButtonId, card._id, 'text');addBtnModal.open()\"\r\n  data-dismiss=\"alert\" aria-hidden=\"true\"><i class=\"fa fa-trash-o\" aria-hidden=\"true\"></i></a>\r\n<div class=\"addbuttonResultList\" (click)=\"editAddBtnModal.open();editButton(card._id, addButton._addButtonId, 'text','addButton')\">\r\n\r\n  <label>{{addButton.buttonname}}</label>\r\n  <p>{{addButton.urlblockname}}</p>\r\n</div>\r\n</div>\r\n<div *ngIf=\"card.data.cardAddButton.length != 3\">\r\n  <div class=\"addbutton\" *ngIf=\"card.data.quickReplyButton.length == 0\" (click)=\"myModal.open();addButton(card._id, 'text','addButton')\">\r\n    <i class=\"fa fa-plus\" aria-hidden=\"true\"></i> Add Button\r\n  </div>\r\n</div>\r\n</div>\r\n<div class=\"top-buttons\">\r\n  <div class=\"button-remove\">\r\n    remove\r\n  </div>\r\n</div>\r\n</div>\r\n</div>\r\n</div>\r\n</li>\r\n<li class=\"list-group-item\" (mouseenter)=\"mouseEnterRM(card._id)\" (mouseleave)=\"mouseLeaveRM(card._id)\" [ngClass]=\"{errorRM: card.isCompleted == false}\"\r\n  *ngIf=\"card.type == 'singletext'\" id=\"{{card._id}}\">\r\n  <a href=\"#\" id=\"closeCard{{card._id}}\" class=\"rmClose\" (click)=\"deleteResponseMessageModal(card._id);responseMessageConfirmationModal.open()\"\r\n    data-dismiss=\"alert\" aria-hidden=\"true\"><i class=\"fa fa-trash-o\" aria-hidden=\"true\"></i></a>\r\n  <div class=\"row\">\r\n    <div class=\"col-md-6 col-lg-6 col-xs-12 col-sm-12\">\r\n      <div class=\"card\">\r\n        <div class=\"card-content col-md-12 col-lg-12 col-xs-12 col-sm-12\">\r\n          <div class=\"contenttitle textcard randomTextCard\">\r\n            <span id=\"textCardCount{{card._id}}\" class=\"textcardCharCount\">{{320 - card.data.text.length}}  </span>\r\n            <!-- (keydown)=\"characterCount(card._id, text.indexId);dynamicHeight($event, card._id, text.indexId)\" -->\r\n            <textarea id=\"textCardTitle{{card._id}}\" rows=\"3\" autosize *ngIf=\"j!=0\" maxlength=\"320\" placeholder=\"Title\" (keyup)=\"characterCountOfSingle(card._id)\"\r\n              (change)=\"updateTitleTextCard(card._id)\">{{card.data.text}}</textarea>\r\n          </div>\r\n          <div *ngFor=\"let addButton of card.data.cardAddButton\" style=\"cursor: pointer\" (mouseenter)=\"mouseEnterTCAB(card._id, addButton._addButtonId)\" (mouseleave)=\"mouseLeaveTCAB(card._id, addButton._addButtonId)\">\r\n<a href=\"#\" id=\"textCardAddBtn{{card._id}}{{addButton._addButtonId}}\" class=\"randomTextClose\" (click)=\"delAddButton(addButton._addButtonId, card._id, 'text');addBtnModal.open()\"\r\n  data-dismiss=\"alert\" aria-hidden=\"true\"><i class=\"fa fa-trash-o\" aria-hidden=\"true\"></i></a>\r\n<div class=\"addbuttonResultList\" (click)=\"editAddBtnModal.open();editButton(card._id, addButton._addButtonId, 'text','addButton')\">\r\n\r\n  <label>{{addButton.buttonname}}</label>\r\n  <p>{{addButton.urlblockname}}</p>\r\n</div>\r\n</div>\r\n<div *ngIf=\"card.data.cardAddButton.length != 3\">\r\n  <div class=\"addbutton\" (click)=\"myModal.open();addButton(card._id, 'text','addButton')\">\r\n    <i class=\"fa fa-plus\" aria-hidden=\"true\"></i> Add Button\r\n  </div>\r\n</div>\r\n</div>\r\n<div class=\"top-buttons\">\r\n  <div class=\"button-remove\">\r\n    remove\r\n  </div>\r\n</div>\r\n</div>\r\n</div>\r\n</div>\r\n</li>\r\n<li class=\"list-group-item\" (mouseenter)=\"mouseEnterRM(card._id)\" (mouseleave)=\"mouseLeaveRM(card._id)\" [ngClass]=\"{errorRM: card.isCompleted == false}\"\r\n  *ngIf=\"card.type == 'image'\" id=\"{{card._id}}\">\r\n  <a href=\"#\" id=\"closeCard{{card._id}}\" class=\"rmClose\" (click)=\"deleteResponseMessageModal(card._id);responseMessageConfirmationModal.open()\"\r\n    data-dismiss=\"alert\" aria-hidden=\"true\"><i class=\"fa fa-trash-o\" aria-hidden=\"true\"></i></a>\r\n  <div class=\"row\">\r\n    <div class=\"col-md-6 col-lg-6 col-xs-12 col-sm-12\">\r\n      <div class=\"card\">\r\n        <div class=\"image col-md-12 col-lg-12 col-xs-12 col-sm-12\">\r\n          <div class=\"image-inner2\">\r\n            <input accept=\"image/*\" type=\"file\" id=\"singleImage{{card._id}}\" (change)=\"populateSingleImage($event, card._id, card._blockId)\"\r\n              style=\"visibility: hidden;\" name=\"files\" title=\"Load File\" />\r\n<div id=\"singleImageBtn{{card._id}}\" *ngIf=\"card.data.pictureUrl == ''\">\r\n  <button (click)=\"openSingleImage(card._id)\" class=\"button-image button-image2 col-xs-12 col-sm-12 btn-gray button-image--replace button-image--replace-gallery\">\r\n                            <span class=\"button-image__title\"><i class=\"fa fa-camera\" aria-hidden=\"true\"></i><br/>Upload Image</span>\r\n                          </button>\r\n</div>\r\n<div id=\"singleImageDiv{{card._id}}\" (mouseenter)=\"mouseEnterSI(card._id)\" (mouseleave)=\"mouseLeaveSI(card._id)\" *ngIf=\"card.data.pictureUrl != ''\"\r\n  [ngStyle]=\"{ 'background-image': 'url(' + card.data.pictureUrl + ')'}\">\r\n  <div class=\"singleImageBGDiv\" id=\"singleImageChangeBtn{{card._id}}\">\r\n    <button class=\"btn\" (click)=\"openSingleImage(card._id)\" style=\"background:transparent\">\r\n<i class=\"fa fa-camera\" aria-hidden=\"true\" style=\"color:white;font-size:24px;\"></i>\r\n</button>\r\n</div>\r\n</div>\r\n</div>\r\n</div>\r\n<div class=\"top-buttons\">\r\n  <div class=\"button-remove\">\r\n    remove\r\n  </div>\r\n</div>\r\n</div>\r\n</div>\r\n</div>\r\n</li>\r\n<li class=\"list-group-item\" (mouseenter)=\"mouseEnterRM(card._id)\" (mouseleave)=\"mouseLeaveRM(card._id)\" [ngClass]=\"{errorRM: card.isCompleted == false}\"\r\n  *ngIf=\"card.type == 'article'\" id=\"{{card._id}}\">\r\n  <a href=\"#\" id=\"closeCard{{card._id}}\" class=\"rmClose\" (click)=\"deleteResponseMessageModal(card._id);responseMessageConfirmationModal.open()\"\r\n    data-dismiss=\"alert\" aria-hidden=\"true\"><i class=\"fa fa-trash-o\" aria-hidden=\"true\"></i></a>\r\n  <div class=\"row table articleHorizontalRow\">\r\n    <div class=\"articleColumns articleColumns{{card._id}}\" (mouseenter)=\"mouseEnterOneArticleCard(articleCard.indexId)\" (mouseleave)=\"mouseLeaveOneArticleCard(articleCard.indexId)\"\r\n          *ngFor=\"let articleCard of card.data\">\r\n      <div class=\"card\">\r\n        <a href=\"#\" id=\"articleRemoveBtn{{articleCard.indexId}}\" class=\"randomArticleTextClose\" (click)=\"delOneArticleCard(card._id, articleCard.indexId);articleIndexModal.open()\"\r\n              data-dismiss=\"alert\" aria-hidden=\"true\"><i class=\"fa fa-trash-o\" aria-hidden=\"true\"></i></a>\r\n        <div class=\"image col-md-12 col-lg-12 col-xs-12 col-sm-1\">\r\n          <div class=\"image-inner\">\r\n            <input accept=\"image/*\" type=\"file\" id=\"articleImage{{articleCard.indexId}}\" (change)=\"populateArticleImage($event, card._id, card._blockId, articleCard.indexId)\"\r\n              style=\"visibility: hidden;\" name=\"files\" title=\"Load File\" />\r\n<div id=\"articleImageBtn{{articleCard.indexId}}\" *ngIf=\"articleCard.pictureUrl == ''\">\r\n  <button (click)=\"openArticleImage(articleCard.indexId)\" class=\"button-image button-image2 col-xs-12 col-sm-12 btn-gray button-image--replace button-image--replace-gallery\">\r\n                            <span class=\"button-image__title\"><i class=\"fa fa-camera\" aria-hidden=\"true\"></i><br/>Upload Image</span>\r\n                          </button>\r\n</div>\r\n<div id=\"articleImageDiv{{articleCard.indexId}}\" (mouseenter)=\"mouseEnterACI(articleCard.indexId)\" (mouseleave)=\"mouseLeaveACI(articleCard.indexId)\" *ngIf=\"articleCard.pictureUrl != ''\"\r\n  [ngStyle]=\"{ 'background-image': 'url(' + articleCard.pictureUrl + ')'}\">\r\n  <div class=\"articleImageBGDiv\" id=\"articleImageChangeBtn{{articleCard.indexId}}\">\r\n    <button class=\"btn\" (click)=\"openArticleImage(articleCard.indexId)\" style=\"background:transparent\">\r\n<i class=\"fa fa-camera\" aria-hidden=\"true\" style=\"color:white;font-size:24px;\"></i>\r\n</button>\r\n</div>\r\n</div>\r\n</div>\r\n</div>\r\n<div class=\"card-content col-md-12 col-lg-12 col-xs-12 col-sm-12\">\r\n<div class=\"contenttitle textcard\" style=\"margin-top: 5px;\">\r\n<textarea id=\"articleCardTitle{{articleCard.indexId}}\" maxlength=\"80\" placeholder=\"Title\" (change)=\"updateTitleArticleCard(card._id,articleCard.indexId)\">{{articleCard.titleText}}</textarea>\r\n</div>\r\n<div class=\"addbutton\" (click)=\"openArticleText(card._id, articleCard.indexId);articleModal.open()\">\r\n  Article\r\n</div>\r\n</div>\r\n</div>\r\n</div>\r\n<div class=\"articleColumns articleColumns{{card._id}}\">\r\n  <div class=\"articlecard add\" (click)=\"addArticleCard(card._id, card._blockId)\">\r\n\r\n  </div>\r\n</div>\r\n<!--</div>-->\r\n</div>\r\n</li>\r\n<li class=\"list-group-item\" (mouseenter)=\"mouseEnterRM(card._id)\" (mouseleave)=\"mouseLeaveRM(card._id)\" [ngClass]=\"{errorRM: card.isCompleted == false}\"\r\n  *ngIf=\"card.type == 'quickreply'\" id=\"{{card._id}}\">\r\n  <a href=\"#\" id=\"closeCard{{card._id}}\" class=\"rmClose\" (click)=\"deleteResponseMessageModal(card._id);responseMessageConfirmationModal.open()\"\r\n    data-dismiss=\"alert\" aria-hidden=\"true\"><i class=\"fa fa-trash-o\" aria-hidden=\"true\"></i></a>\r\n  <div class=\"row\">\r\n    <!--id=\"block{{block._id}}\" *ngFor=\"let block of blockGroups.blocks\" (click)=\"blockDetail(block._id)\" -->\r\n    <div class=\"col-md-12 col-lg-12 col-xs-12 col-sm-12\">\r\n      <div class=\"QuickReplyButtons qrbtns\" (mouseenter)=\"mouseEnter(quickReply._addButtonId) \" (mouseleave)=\"mouseLeave(quickReply._addButtonId)\"\r\n        *ngFor=\"let quickReply of card.data.quickReplyBtns\">\r\n        <a id=\"{{quickReply._addButtonId}}\" (click)=\"delQuickReply(quickReply._addButtonId, card._id);quickReplyBtnModal.open()\"\r\n          class=\"quickReplyClose\" data-dismiss=\"alert\" aria-hidden=\"true\"><i class=\"fa fa-trash-o quickReplyCloseBtn\" aria-hidden=\"true\"></i></a>\r\n        <div (click)=\"editQuickReplyModal.open();editQR(quickReply._addButtonId, card._id, quickReply.buttonname, quickReply._blockId)\">\r\n\r\n\r\n          {{quickReply.buttonname}}\r\n        </div>\r\n      </div>\r\n      <div class=\"QuickReplyButtons QuickReplyButtonsBlack\" (click)=\"yourModal.open();addQuickReplyBtn(card._id)\">\r\n        <i class=\"fa fa-plus\" aria-hidden=\"true\"></i> Add Quick Reply\r\n      </div>\r\n    </div>\r\n    <!--</div>-->\r\n  </div>\r\n</li>\r\n</div>\r\n</ul>\r\n<div class=\"row topmargin\">\r\n  <div class=\"col-md-3 col-lg-3\">\r\n    <legend>\r\n      <span>Add a Card</span>\r\n    </legend>\r\n  </div>\r\n</div>\r\n<div class=\"row\">\r\n  <div class=\"col-md-12 col-lg-12\">\r\n    <div class=\"btn-group\">\r\n      <button type=\"button\" (click)=\"addCard(1)\" class=\"btn width-100 mb-xs\"><i class=\"fa fa-picture-o\" aria-hidden=\"true\"></i><br/>Gallery</button>\r\n      <button type=\"button\" *ngIf=\"isLocked==false\" (click)=\"addCard(6)\" class=\"btn width-100 mb-xs\"><i class=\"fa fa-file-text-o\" aria-hidden=\"true\"></i><br/>Text Card</button>\r\n      <button type=\"button\" *ngIf=\"isLocked==true\" (click)=\"addCard(2)\" class=\"btn width-100 mb-xs\"><i class=\"fa fa-file-text-o\" aria-hidden=\"true\"></i><br/>RAND Text</button>\r\n      <button type=\"button\" (click)=\"addCard(3)\" class=\"btn width-100 mb-xs\"><i class=\"fa fa-picture-o\" aria-hidden=\"true\"></i><br/>Image</button>\r\n      <button type=\"button\" (click)=\"addCard(4)\" class=\"btn width-100 mb-xs\"><i class=\"fa fa-info-circle\" aria-hidden=\"true\"></i><br/>Article</button>\r\n      <button type=\"button\" (click)=\"addCard(5)\" class=\"btn width-100 mb-xs\"><i class=\"fa fa-link\" aria-hidden=\"true\"></i><br/>Quick Reply</button>\r\n    </div>\r\n  </div>\r\n</div>\r\n</div>\r\n<div class=\"col-md-6 col-sm-12 col-lg-6 col-xs-12 articleEditor\" style=\"display:none\">\r\n\r\n</div>\r\n</div>\r\n</div>\r\n</section>\r\n<modal #myModal (onClose)=\"actionOnClose()\">\r\n  <modal-header>\r\n    <h4 class=\"modal-title text-xs-center fw-bold mt\" id=\"myModalLabel18\">Add Button to Response</h4>\r\n    <input id=\"buttonName\" type=\"text\" class=\"form-control\" maxlength=\"20\" [(ngModel)]=\"AddButtonName\" placeholder=\"Enter Button Name\"\r\n      style=\"width:88%;margin-left:5%;\" />\r\n</modal-header>\r\n<modal-content>\r\n  <div class=\"col-md-12 col-lg-12\">\r\n    <ul class=\"addButtonList\">\r\n      <li (click)=\"modalChangeTab(1)\" id=\"blockBtn\" class=\"addButtonListItem modalliactive\"><a class=\"modalliitem\">Block</a></li>\r\n      <li (click)=\"modalChangeTab(2)\" id=\"urlBtn\" class=\"addButtonListItem\"><a class=\"modalliitem\">Url</a></li>\r\n    </ul>\r\n    <div class=\"modalContent\">\r\n      <div id=\"blockContent\" class=\"row modalContentActive\">\r\n        <div class=\"col-md-12 col-xs-12\">\r\n          <div class=\"form-group row\">\r\n            <div class=\"col-md-12\">\r\n              <select class=\"form-control\" [(ngModel)]=\"AddButtonBlock\" name=\"blocksdd\" id=\"simple-select\">\r\n                  <option selected=\"true\" value=\"0\">Select Block</option>\r\n                  <option *ngFor=\"let card of select2GroupedData\" value=\"{{card.id}}\">{{card.text}}</option>\r\n                  \r\n                </select>\r\n            </div>\r\n          </div>\r\n          <div class=\"row\">\r\n            <div class=\"col-md-12\">\r\n              <button type=\"button\" class=\"btn btn-success btn-block\" (click)=\"addButtonPost(1)\">Save</button>\r\n            </div>\r\n          </div>\r\n        </div>\r\n      </div>\r\n      <div id=\"urlContent\" class=\"row modalContentDeActive\">\r\n        <div class=\"col-md-12 col-xs-12\">\r\n          <div class=\"form-group row\">\r\n            <div class=\"col-md-12\">\r\n              <div class=\"input-group\">\r\n                <span class=\"input-group-addon\">http://</span>\r\n                <input id=\"urlContentData\" class=\"form-control\" type=\"text\" [(ngModel)]=\"AddButtonUrl\" placeholder=\"Enter URL\">\r\n              </div>\r\n              <!--<input id=\"urlContentData\" type=\"text\" class=\"form-control\" [(ngModel)]=\"AddButtonUrl\" placeholder=\"Enter Url\" />-->\r\n            </div>\r\n          </div>\r\n          <div class=\"row\">\r\n            <div class=\"col-md-12\">\r\n              <button type=\"button\" class=\"btn btn-success btn-block\" (click)=\"addButtonPost(2)\">Save</button>\r\n            </div>\r\n          </div>\r\n        </div>\r\n      </div>\r\n      <div id=\"articleContent\" class=\"row modalContentDeActive\">\r\n        <div class=\"col-md-12 col-xs-12\">\r\n          <div class=\"form-group row\">\r\n            <div class=\"col-md-12\">\r\n              <input id=\"urlContentData\" type=\"text\" class=\"form-control\" [(ngModel)]=\"AddButtonUrl\" placeholder=\"Enter URL\" />\r\n            </div>\r\n          </div>\r\n          <div class=\"row\">\r\n            <div class=\"col-md-12\">\r\n              <button type=\"button\" class=\"btn btn-success btn-block\" (click)=\"addButtonPost(2)\">Save</button>\r\n            </div>\r\n          </div>\r\n        </div>\r\n      </div>\r\n    </div>\r\n  </div>\r\n</modal-content>\r\n<modal-footer>\r\n</modal-footer>\r\n</modal>\r\n<modal #yourModal (onClose)=\"actionOnClose()\">\r\n  <modal-header>\r\n    <h4 class=\"modal-title text-xs-center fw-bold mt\" id=\"myModalLabel18\">Add Quick Reply</h4>\r\n    <input id=\"buttonNameQR\" type=\"text\" class=\"form-control\" maxlength=\"20\" [(ngModel)]=\"QuickReplyButtonName\" placeholder=\"Enter Button Name\"\r\n      style=\"width:88%;margin-left:5%;\" />\r\n</modal-header>\r\n<modal-content>\r\n  <div class=\"col-md-12 col-lg-12\">\r\n    <ul class=\"addButtonList\">\r\n      <li id=\"blockBtn\" class=\"addButtonListItem\">\r\n        <a class=\"modalliitem\" style=\"padding: 0em 6em;\">Block</a>\r\n</li>\r\n</ul>\r\n<div class=\"modalContent\">\r\n  <div id=\"blockContent\" class=\"row modalContentActive\">\r\n    <div class=\"col-md-12 col-xs-12\">\r\n      <div class=\"form-group row\">\r\n        <div class=\"col-md-12\">\r\n          <select class=\"form-control\" [(ngModel)]=\"QuickReplyButtonBlock\" name=\"blocksdd\" id=\"simple-select\">\r\n                  <option selected=\"selected\" value=\"0\">Select Block</option>\r\n                  <option *ngFor=\"let card of select2GroupedData\" value=\"{{card.id}}\">{{card.text}}</option>   \r\n                </select>\r\n        </div>\r\n      </div>\r\n      <div class=\"row\">\r\n        <div class=\"col-md-12\">\r\n          <button type=\"button\" class=\"btn btn-success btn-block\" (click)=\"submitQuickReplyBtns();\">Save</button>\r\n        </div>\r\n      </div>\r\n    </div>\r\n  </div>\r\n</div>\r\n</div>\r\n</modal-content>\r\n<modal-footer>\r\n</modal-footer>\r\n</modal>\r\n<modal #articleModal (onClose)=\"actionOnClose()\">\r\n  <modal-header>\r\n    <h4 class=\"modal-title text-xs-center fw-bold mt\" id=\"myModalLabel18\">Article for {{articleModalTitle}}</h4>\r\n  </modal-header>\r\n  <modal-content>\r\n    <div class=\"col-md-12 col-lg-12\">\r\n      <div class=\"modalContent\">\r\n        <quill-editor [(ngModel)]=\"ckeditorContent\"></quill-editor>\r\n      </div>\r\n      <div class=\"row\">\r\n        <div class=\"col-md-12\">\r\n          <button type=\"button\" class=\"btn btn-success btn-block\" (click)=\"submitArticleText();articleModal.close()\">Save</button>\r\n        </div>\r\n      </div>\r\n    </div>\r\n  </modal-content>\r\n  <modal-footer>\r\n  </modal-footer>\r\n</modal>\r\n<modal #editQuickReplyModal (onClose)=\"actionOnClose()\">\r\n  <modal-header>\r\n    <h4 class=\"modal-title text-xs-center fw-bold mt\" id=\"myModalLabel18\">Edit Quick Reply</h4>\r\n    <input id=\"buttonNameEditQR\" type=\"text\" class=\"form-control\" maxlength=\"20\" [(ngModel)]=\"EditQuickReplyName\" placeholder=\"Enter Button Name\"\r\n      style=\"width:88%;margin-left:5%;\" />\r\n</modal-header>\r\n<modal-content>\r\n  <div class=\"col-md-12 col-lg-12\">\r\n    <!--<ul class=\"addButtonList\">\r\n        <li id=\"blockBtn\" class=\"addButtonListItem\"><a class=\"modalliitem\" style=\"padding: 0em 6em;\">Blocks</a></li>\r\n      </ul>-->\r\n    <div class=\"modalContent\">\r\n      <div id=\"blockContent\" class=\"row modalContentActive\">\r\n        <div class=\"col-md-12 col-xs-12\">\r\n          <div class=\"form-group row\">\r\n            <div class=\"col-md-12\">\r\n              <select class=\"form-control\" [(ngModel)]=\"EditBlockQuickReply\" name=\"blocksdd\" id=\"editQR-select\">\r\n                  <option selected=\"selected\" value=\"0\">Select Block</option>\r\n                  <option *ngFor=\"let card of select2GroupedData\" [selected]=\"card.id == EditBlockQuickReply\" value=\"{{card.id}}\">{{card.text}}</option>   \r\n                </select>\r\n            </div>\r\n          </div>\r\n          <div class=\"row\">\r\n            <div class=\"col-md-12\">\r\n              <button type=\"button\" class=\"btn btn-success btn-block\" (click)=\"editQuickReplyBtns()\">Update</button>\r\n            </div>\r\n          </div>\r\n        </div>\r\n      </div>\r\n    </div>\r\n  </div>\r\n</modal-content>\r\n<modal-footer>\r\n</modal-footer>\r\n</modal>\r\n<modal #editAddBtnModal (onClose)=\"actionOnClose()\">\r\n  <modal-header>\r\n    <h4 class=\"modal-title text-xs-center fw-bold mt\" id=\"myModalLabel18\">Edit Button to Response</h4>\r\n    <input id=\"buttonName\" type=\"text\" class=\"form-control\" maxlength=\"20\" [(ngModel)]=\"EditButtonName\" placeholder=\"Enter Button Name\"\r\n      style=\"width:88%;margin-left:5%;\" />\r\n</modal-header>\r\n<modal-content>\r\n  <div class=\"col-md-12 col-lg-12\">\r\n    <ul class=\"addButtonList\">\r\n      <li (click)=\"modalChangeTab(1)\" id=\"blockBtn\" class=\"addButtonListItem modalliactive\"><a class=\"modalliitem\">Block</a></li>\r\n      <li (click)=\"modalChangeTab(2)\" id=\"urlBtn\" class=\"addButtonListItem\"><a class=\"modalliitem\">Url</a></li>\r\n    </ul>\r\n    <div class=\"modalContent\">\r\n      <div id=\"blockContent\" class=\"row modalContentActive\">\r\n        <div class=\"col-md-12 col-xs-12\">\r\n\r\n          <div class=\"form-group row\">\r\n            <div class=\"col-md-12\">\r\n              <select class=\"form-control\" [(ngModel)]=\"EditButtonBlock\" name=\"blocksdd\" id=\"simple-select\">\r\n                  <option selected=\"selected\" value=\"0\">Select Block</option>\r\n                  <option *ngFor=\"let card of select2GroupedData\" value=\"{{card.id}}\">{{card.text}}</option>\r\n                  \r\n                </select>\r\n            </div>\r\n          </div>\r\n          <div class=\"row\">\r\n            <div class=\"col-md-12\">\r\n              <button type=\"button\" class=\"btn btn-success btn-block\" (click)=\"editButtonPost(1);\">Update</button>\r\n            </div>\r\n          </div>\r\n        </div>\r\n      </div>\r\n      <div id=\"urlContent\" class=\"row modalContentDeActive\">\r\n        <div class=\"col-md-12 col-xs-12\">\r\n          <div class=\"form-group row\">\r\n\r\n            <div class=\"col-md-12\">\r\n              <div class=\"input-group\">\r\n                <span class=\"input-group-addon\">http://</span>\r\n                <input id=\"urlContentData\" class=\"form-control\" type=\"text\" [(ngModel)]=\"EditButtonUrl\" placeholder=\"Enter Url\">\r\n              </div>\r\n              <!--<input id=\"urlContentData\" type=\"text\" class=\"form-control\" [(ngModel)]=\"AddButtonUrl\" placeholder=\"Enter Url\" />-->\r\n            </div>\r\n          </div>\r\n          <div class=\"row\">\r\n            <div class=\"col-md-12\">\r\n              <button type=\"button\" class=\"btn btn-success btn-block\" (click)=\"editButtonPost(2);editAddBtnModal.close()\">Update</button>\r\n            </div>\r\n          </div>\r\n        </div>\r\n      </div>\r\n    </div>\r\n  </div>\r\n</modal-content>\r\n<modal-footer>\r\n</modal-footer>\r\n</modal>\r\n<modal #groupConfirmationModal>\r\n  <modal-header>\r\n    <h4 class=\"modal-title text-xs-center fw-bold mt\" id=\"myModalLabel18\">Confirmation</h4>\r\n    <p class=\"text-xs-center fs-mini text-muted mt-sm\">\r\n      Do you really want to remove the Group?\r\n    </p>\r\n  </modal-header>\r\n  <modal-content>\r\n    <form>\r\n      <div class=\"row\">\r\n        <div class=\"col-lg-6 col-xs-12\">\r\n          <button type=\"button\" class=\"btn btn-success pull-right\" (click)=\"deleteGroup()\">Yes</button>\r\n        </div>\r\n        <div class=\"col-lg-6 col-xs-12\">\r\n          <button type=\"button\" class=\"btn btn-danger pull-left\" (click)=\"groupConfirmationModal.close()\">No</button>\r\n        </div>\r\n      </div>\r\n    </form>\r\n  </modal-content>\r\n</modal>\r\n<modal #blockConfirmationModal>\r\n  <modal-header>\r\n    <h4 class=\"modal-title text-xs-center fw-bold mt\" id=\"myModalLabel18\">Confirmation</h4>\r\n    <p class=\"text-xs-center fs-mini text-muted mt-sm\">\r\n      Do you really want to remove the Block?\r\n    </p>\r\n  </modal-header>\r\n  <modal-content>\r\n    <form>\r\n      <div class=\"row\">\r\n        <div class=\"col-lg-6 col-xs-12\">\r\n          <button type=\"button\" class=\"btn btn-success pull-right\" (click)=\"deleteBlock()\">Yes</button>\r\n        </div>\r\n        <div class=\"col-lg-6 col-xs-12\">\r\n          <button type=\"button\" class=\"btn btn-danger pull-left\" (click)=\"blockConfirmationModal.close()\">No</button>\r\n        </div>\r\n      </div>\r\n    </form>\r\n  </modal-content>\r\n</modal>\r\n<modal #responseMessageConfirmationModal>\r\n  <modal-header>\r\n    <h4 class=\"modal-title text-xs-center fw-bold mt\" id=\"myModalLabel18\">Confirmation</h4>\r\n    <p class=\"text-xs-center fs-mini text-muted mt-sm\">\r\n      Do you really want to remove this card ?\r\n    </p>\r\n  </modal-header>\r\n  <modal-content>\r\n    <form>\r\n      <div class=\"row\">\r\n        <div class=\"col-lg-6 col-xs-12\">\r\n          <button type=\"button\" class=\"btn btn-success pull-right\" (click)=\"deleteResponseMessage();\">Yes</button>\r\n        </div>\r\n        <div class=\"col-lg-6 col-xs-12\">\r\n          <button type=\"button\" class=\"btn btn-danger pull-left\" (click)=\"responseMessageConfirmationModal.close()\">No</button>\r\n        </div>\r\n      </div>\r\n    </form>\r\n  </modal-content>\r\n</modal>\r\n<modal #randomTextCardModal>\r\n  <modal-header>\r\n    <h4 class=\"modal-title text-xs-center fw-bold mt\" id=\"myModalLabel18\">Confirmation</h4>\r\n    <p class=\"text-xs-center fs-mini text-muted mt-sm\">\r\n      Do you really want to remove this Random text ?\r\n    </p>\r\n  </modal-header>\r\n  <modal-content>\r\n    <form>\r\n      <div class=\"row\">\r\n        <div class=\"col-lg-6 col-xs-12\">\r\n          <button type=\"button\" class=\"btn btn-success pull-right\" (click)=\"deleteRandomTextBox();\">Yes</button>\r\n        </div>\r\n        <div class=\"col-lg-6 col-xs-12\">\r\n          <button type=\"button\" class=\"btn btn-danger pull-left\" (click)=\"randomTextCardModal.close()\">No</button>\r\n        </div>\r\n      </div>\r\n    </form>\r\n  </modal-content>\r\n</modal>\r\n<modal #addBtnModal>\r\n  <modal-header>\r\n    <h4 class=\"modal-title text-xs-center fw-bold mt\" id=\"myModalLabel18\">Confirmation</h4>\r\n    <p class=\"text-xs-center fs-mini text-muted mt-sm\">\r\n      Do you really want to remove this Button ?\r\n    </p>\r\n  </modal-header>\r\n  <modal-content>\r\n    <form>\r\n      <div class=\"row\">\r\n        <div class=\"col-lg-6 col-xs-12\">\r\n          <button type=\"button\" class=\"btn btn-success pull-right\" (click)=\"deleteAddButton();\">Yes</button>\r\n        </div>\r\n        <div class=\"col-lg-6 col-xs-12\">\r\n          <button type=\"button\" class=\"btn btn-danger pull-left\" (click)=\"addBtnModal.close()\">No</button>\r\n        </div>\r\n      </div>\r\n    </form>\r\n  </modal-content>\r\n</modal>\r\n<modal #quickReplyBtnModal>\r\n  <modal-header>\r\n    <h4 class=\"modal-title text-xs-center fw-bold mt\" id=\"myModalLabel18\">Confirmation</h4>\r\n    <p class=\"text-xs-center fs-mini text-muted mt-sm\">\r\n      Do you really want to remove this Quick Reply Button ?\r\n    </p>\r\n  </modal-header>\r\n  <modal-content>\r\n    <form>\r\n      <div class=\"row\">\r\n        <div class=\"col-lg-6 col-xs-12\">\r\n          <button type=\"button\" class=\"btn btn-success pull-right\" (click)=\"deleteQuickReply();\">Yes</button>\r\n        </div>\r\n        <div class=\"col-lg-6 col-xs-12\">\r\n          <button type=\"button\" class=\"btn btn-danger pull-left\" (click)=\"quickReplyBtnModal.close()\">No</button>\r\n        </div>\r\n      </div>\r\n    </form>\r\n  </modal-content>\r\n</modal>\r\n<modal #galleryIndexModal>\r\n  <modal-header>\r\n    <h4 class=\"modal-title text-xs-center fw-bold mt\" id=\"myModalLabel18\">Confirmation</h4>\r\n    <p class=\"text-xs-center fs-mini text-muted mt-sm\">\r\n      Do you really want to remove this Gallery Card ?\r\n    </p>\r\n  </modal-header>\r\n  <modal-content>\r\n    <form>\r\n      <div class=\"row\">\r\n        <div class=\"col-lg-6 col-xs-12\">\r\n          <button type=\"button\" class=\"btn btn-success pull-right\" (click)=\"deleteGalleryCardBtn();\">Yes</button>\r\n        </div>\r\n        <div class=\"col-lg-6 col-xs-12\">\r\n          <button type=\"button\" class=\"btn btn-danger pull-left\" (click)=\"galleryIndexModal.close()\">No</button>\r\n        </div>\r\n      </div>\r\n    </form>\r\n  </modal-content>\r\n</modal>\r\n<modal #articleIndexModal>\r\n  <modal-header>\r\n    <h4 class=\"modal-title text-xs-center fw-bold mt\" id=\"myModalLabel18\">Confirmation</h4>\r\n    <p class=\"text-xs-center fs-mini text-muted mt-sm\">\r\n      Do you really want to remove this Article Card ?\r\n    </p>\r\n  </modal-header>\r\n  <modal-content>\r\n    <form>\r\n      <div class=\"row\">\r\n        <div class=\"col-lg-6 col-xs-12\">\r\n          <button type=\"button\" class=\"btn btn-success pull-right\" (click)=\"deleteArticleCardBtn();\">Yes</button>\r\n        </div>\r\n        <div class=\"col-lg-6 col-xs-12\">\r\n          <button type=\"button\" class=\"btn btn-danger pull-left\" (click)=\"articleIndexModal.close()\">No</button>\r\n        </div>\r\n      </div>\r\n    </form>\r\n  </modal-content>\r\n</modal>"
...
var Specific = (function () {
    ...
    Specific.prototype.mouseEnterRM = function (id) {
        jQuery('#closeCard' + id).show();
    };
    Specific.prototype.mouseLeaveRM = function (id) {
        jQuery('#closeCard' + id).hide();
    };
    ...
    Specific.prototype.mouseEnterACI = function (id) {
        jQuery('#articleImageChangeBtn' + id).show();
    };
    Specific.prototype.mouseLeaveACI = function (id) {
        jQuery('#articleImageChangeBtn' + id).hide();
    };
    ...
    Specific.prototype.mouseEnterOneGalleryCard = function (Id) {
        jQuery('#galleryRemoveBtn' + Id).show();
    };
    Specific.prototype.mouseLeaveOneGalleryCard = function (Id) {
        jQuery('#galleryRemoveBtn' + Id).hide();
    };
    Specific.prototype.mouseEnterOneArticleCard = function (Id) {
        jQuery('#articleRemoveBtn' + Id).show();
    };
    Specific.prototype.mouseLeaveOneArticleCard = function (Id) {
        jQuery('#articleRemoveBtn' + Id).hide();
    };
    ///////////////////////////////////////////////
    ...
    Specific.prototype.addTextRandom = function (responseMessageId) {
        var _this = this;
        if (this.randomTextFlag == true) {
            this.randomTextFlag = false;
        ...
        this._botTrainingService.getAllGroups2('-1').subscribe(function (a) {
            if (a.code == 200) {
                for (var i = 0; i < a.data.length; i++) {
                    if (a.data[i].blocks.length > 0) {
                        for (var j = 0; j < a.data[i].blocks.length; j++) {
                            _this.select2GroupedData.push({ id: a.data[i].blocks[j]._id, text: a.data[i].blocks[j].name });
                        }
                    }
                }
            }
    ...
    Specific.prototype.submitQuickReplyBtns = function () {
        ...
        var specialCharacterFlag = false;
        if (/^[a-zA-Z0-9- ]*$/.test(this.QuickReplyButtonName) == false) {
            specialCharacterFlag = true;
        }
    ...
    Specific.prototype.submitArticleText = function () {
        var _this = this;
        var content = this.ckeditorContent;
        if (this.ckeditorContent !== undefined && this.ckeditorContent != "" && this.ckeditorContent != null) {
            this._botTrainingService.updateArticleText(this.articleResponseMessageId, this.articleResponseId, this.ckeditorContent).subscribe(function (a) {
                if (a.code == 200) {
                    if (a.data == true) {
                        _this.blockIsCompletedStatusChange(_this.popBlock._id, true);
                    }
                    ...
                    for (var i = 0; i < _this.cardArray.length; i++) {
                        if (_this.cardArray[i]._id == _this.articleResponseMessageId) {
                    ...
                    for (var i = 0; i < _this.cardArray.length; i++) {
                        if (_this.cardArray[i]._id == _this.articleResponseMessageId) {
                            for (var j = 0; j < _this.cardArray[i].data.length; j++) {
                                if (_this.cardArray[i].data[j].indexId == _this.articleResponseId) {
                                    _this.cardArray[i].data[j].articleText = content;
                                    break;
                                }
                            }
                        }
    ...
    Specific.prototype.openArticleText = function (responseMessageId, Id) {
        this.articleResponseId = Id;
        this.articleResponseMessageId = responseMessageId;
        for (var j = 0; j < this.cardArray.length; j++) {
            if (this.cardArray[j]._id == responseMessageId) {
                for (var k = 0; k < this.cardArray[j].data.length; k++) {
                    if (this.cardArray[j].data[k].indexId == Id) {
                        var text = this.cardArray[j].data[k].articleText;
                        this.ckeditorContent = text;
                        this.articleModalTitle = this.cardArray[j].data[k].titleText;
                    }
                }
                break;
            }
    ...
    Specific.prototype.updateTitleArticleCard = function (responseMessageId, articleCardId) {
        var _this = this;
        console.log(jQuery('#articleCardTitle' + articleCardId).val());
        this._botTrainingService.updateTitleText(responseMessageId, jQuery('#articleCardTitle' + articleCardId).val(), articleCardId, 'article').subscribe(function (a) {
            if (a.code == 200) {
                if (a.data == true) {
                    _this.blockIsCompletedStatusChange(_this.popBlock._id, true);
                }
                ...
                for (var i = 0; i < _this.cardArray.length; i++) {
                    if (_this.cardArray[i]._id == responseMessageId) {
                        for (var j = 0; j < _this.cardArray[i].data.length; j++) {
                            if (_this.cardArray[i].data[j].indexId == articleCardId) {
                                _this.cardArray[i].data[j].titleText = jQuery('#articleCardTitle' + articleCardId).val();
                                break;
                            }
                        }
                    }
    ...
    Specific.prototype.openArticleImage = function (Id) {
        jQuery('#articleImage' + Id).click();
    };
    ...
    Specific.prototype.populateArticleImage = function (event, responseMessageId, blockId, indexId) {
        var _this = this;
        var file = event.target.files[0];
        this._botTrainingService.getPictureUrl(file, responseMessageId, "article", indexId).subscribe(function (a) {
            if (a.code == 200) {
                console.log(a.data);
                for (var i = 0; i < _this.cardArray.length; i++) {
                    if (_this.cardArray[i]._id == responseMessageId) {
    ...
    Specific.prototype.addArticleCard = function (resMesId, blockId) {
        var _this = this;
        this.articleCard = new ArticleCard_1.ArticleCard("", "", "", "");
        //this.card = new Card("gallery", this.galleryCard);
        this._botTrainingService.addArticleCard(this.articleCard, resMesId).subscribe(function (a) {
            console.log(a);
            if (a.code == 200) {
                if (a.data == true) {
                    _this.blockIsCompletedStatusChange(_this.popBlock._id, true);
    ...
    Specific.prototype.saveBlock = function (Id) {
        var _this = this;
        var blockName = jQuery('#blockText' + Id).val();
        var specialCharacterFlag = false;
        if (/^[a-zA-Z0-9- ]*$/.test(blockName) == false) {
            specialCharacterFlag = true;
        }
        if (blockName.match(/[a-z]/i)) {
            specialCharacterFlag = false;
        }
        if (specialCharacterFlag == false) {
            jQuery('#specialCharactersGroup' + Id).fadeOut("slow");
        }
        jQuery('#blockText' + Id).css('border', '1px solid rgba(0, 0, 0, 0.15);');
        if (blockName != "" && blockName !== undefined && this.addBlockFlag == false && blockName.replace(/\s/g, '').length != 0 && specialCharacterFlag == false) {
            this.addBlockFlag = true;
            this._botTrainingService.addBlocks(blockName, 'Specific', Id).subscribe(function (a) {
                if (a.code == 200) {
                    _this.addBlockFlag = false;
                    jQuery('.addBlock' + Id).show();
                    jQuery('.saveBlock' + Id).hide();
                    jQuery('#blockText' + Id).val("");
                    jQuery('#duplicateBlock' + Id).fadeOut("slow");
                    _this.addedBlock = a.data;
                    _this.select2GroupedData.push({ id: _this.addedBlock._id, text: _this.addedBlock.name });
                    ...
                    _this.addBlockFlag = false;
                    jQuery('#duplicateBlock' + Id).fadeIn("slow");
                }
            });
        }
        else if (specialCharacterFlag == true) {
            this.addBlockFlag = false;
            jQuery('#specialCharactersGroup' + Id).fadeIn("slow");
        }
        else {
            this.addBlockFlag = false;
    ...
    Specific.prototype.addCard = function (val) {
        ...
        if (val == 1) {
            ...
            //Article
            this.articleCard = new ArticleCard_1.ArticleCard("", "", "", "");
            this.card = new Card_1.Card("article", this.articleCard);
            var articleCardArray = [];
            articleCardArray.push(this.articleCard);
            this._botTrainingService.addResponseMessage(articleCardArray, "article", this.popBlock._id).subscribe(function (a) {
                if (a.code == 200) {
                    _this.blockIsCompletedStatusChange(a.data._blockId, false);
                    //this.cardArray.push(a.data);
                    _this.blockDetail(_this.popBlock._id);
    ...
    Specific.prototype.actionOnClose = function () {
        this.AddButtonName = "";
        this.AddButtonBlock = "";
        this.AddButtonUrl = "";
        this.QuickReplyButtonName = "";
    ...
    Specific.prototype.RenderSortable = function () {
        var oldIndex;
        var self = this;
        jQuery(function () {
            jQuery('.mainlist').sortable({
                cursor: "grabbing",
                handle: '.fa-sort',
                connectWith: '.mainlist',
                items: "li:not(.groupunsortable)",
                ...
                update: function (e, ui) {
                    ...
                    jQuery.post(self.urlService.baseUrl + "groups/setOrderOfGroups", {
                        oldIndex: oldIndex,
                        newIndex: newIndex,
                        groupId: groupId,
                        type: 'Specific'
                ...
                beforeStop: function (ev, ui) {
                    if (jQuery(ui.item).hasClass('hasItems') && jQuery(ui.placeholder).parent()[0] != this) {
                        jQuery(this).sortable('cancel');
                    }
                }
            });
            var blockId;
            jQuery('.sublist').sortable({
                cursor: "grabbing",
                ...
                update: function (e, ui) {
                    ...
                    if (blockId === undefined) {
                        blockId = jQuery(this).attr('data-previndex');
                    }
                    jQuery.post(self.urlService.baseUrl + "blocks/sortBlock", {
                        oldIndex: oldIndex,
                        newIndex: newIndex,
                        blockId: blockId,
                        groupId: ul[0].id
    ...
    Specific.prototype.ngOnInit = function () {
        ...
        jQuery("body").click(function (e) {
            if (e.target.className !== "blockNameDiv" && e.target.className !== "blockNameDiv2" && e.target.className !== "blockNameDiv form-control" && e.target.className !== "GroupName") {
                jQuery('#blockNameHeading').show();
                jQuery('#blockNameChange').hide();
                jQuery('.GroupName').show();
                jQuery('.blockNameDiv').hide();
            }
        });
        ...
        jQuery(".list-group-sortable").sortable({
            ...
            update: function (e, ui) {
                ...
                var newIndex = ui.item.index() + 1;
                var groupId = jQuery(this).attr('data-previndex');
                jQuery.post(self.urlService.baseUrl + "responsemessage/sortingOfResponseMessages", {
                    oldIndex: oldIndex,
                    newIndex: newIndex,
                    groupId: groupId
                }, function (data, status) {
    ...
    Specific.prototype.toggleDivs = function (val) {
        ...
        if (val == 1) {
            ...
            jQuery('#emptyGroup').hide();
            var specialCharacterFlag = false;
            if (/^[a-zA-Z0-9- ]*$/.test(this.GroupText) == false) {
                specialCharacterFlag = true;
            }
            if (this.GroupText.match(/[a-z]/i)) {
                specialCharacterFlag = false;
            }
            if (specialCharacterFlag == false) {
                jQuery('#specialCharactersGroup').fadeOut("slow");
            }
            if (this.GroupText != "" && this.addGroupFlag == false && this.GroupText.replace(/\s/g, '').length != 0 && specialCharacterFlag == false) {
                ...
                this._botTrainingService.addGroup(this.GroupText, 'Specific').subscribe(function (a) {
                    ...
                    if (a.code == 200) {
                        ...
                        _this.addGroupFlag = false;
                        jQuery('#duplicateGroup').fadeIn("slow");
                    }
                });
            }
            else if (specialCharacterFlag == true) {
    ...
    Specific.prototype.refreshBlockTextBox = function (_id) {
        jQuery('#blockText' + _id).val('');
    };
    Specific.prototype.crossBlockTextBox = function (_id) {
        jQuery('.addBlock' + _id).show();
        jQuery('.saveBlock' + _id).hide();
        jQuery('#blockText' + _id).val('');
    };
    ...
    Specific.prototype.changeBlockName = function () {
        jQuery('#blockNameHeading').hide();
        jQuery('#blockNameChange').show();
    };
    Specific.prototype.changeGroupName = function (val) {
        jQuery('#GroupNameDiv' + val).hide();
        jQuery('#groupNameChange' + val).show();
    };
    Specific.prototype.editGroupName = function (Id) {
        var _this = this;
        this._botTrainingService.updateGroupName(Id, jQuery('#groupNameChange' + Id).val())
            .subscribe(function (a) {
            if (a.code == 200) {
                _this.popBlockName = jQuery('#blockNameChange').val();
                jQuery('#GroupNameDiv' + Id).show();
                jQuery('#groupNameChange' + Id).hide();
                jQuery('#editduplicateGroup' + Id).hide();
                for (var i = 0; i < _this.blockGroupsModel.length; i++) {
                    //for (var j = 0; j < this.blockGroupsModel[i].blocks.length; j++) {
                    if (_this.blockGroupsModel[i].group._id == Id) {
                        _this.blockGroupsModel[i].group.name = jQuery('#groupNameChange' + Id).val();
                        break;
                    }
                }
            }
            else if (a.code == 300) {
                jQuery('#GroupNameDiv' + Id).hide();
                jQuery('#groupNameChange' + Id).show();
                jQuery('#editduplicateGroup' + Id).show();
            }
        });
    };
    Specific.prototype.editBlockName = function (Id) {
        var _this = this;
        this._botTrainingService.updateBlockName(this.popBlock._id, jQuery('#blockNameChange').val())
            .subscribe(function (a) {
            if (a.code == 200) {
                _this.popBlockName = jQuery('#blockNameChange').val();
                jQuery('#blockNameHeading').show();
                jQuery('#blockNameChange').hide();
                jQuery('#editduplicateBlock' + Id).hide();
                for (var i = 0; i < _this.blockGroupsModel.length; i++) {
                    for (var j = 0; j < _this.blockGroupsModel[i].blocks.length; j++) {
                        if (_this.blockGroupsModel[i].blocks[j]._id == _this.popBlock._id) {
                            _this.blockGroupsModel[i].blocks[j].name = jQuery('#blockNameChange').val();
                            break;
                        }
                    }
                }
                ...
                jQuery('#editduplicateBlock' + Id).show();
            }
        });
    };
    ...
    Specific.prototype.editQuickReplyBtns = function () {
        var _this = this;
        jQuery('#editQR-select').removeClass('modalError');
        jQuery('#buttonNameEditQR').removeClass('modalError');
        var specialCharacterFlag = false;
        if (/^[a-zA-Z0-9- ]*$/.test(this.EditQuickReplyName) == false) {
            specialCharacterFlag = true;
        }
        if (this.EditQuickReplyName.match(/[a-z]/i)) {
            specialCharacterFlag = false;
        }
        if (this.EditQuickReplyName != "" && this.EditQuickReplyName.replace(/\s/g, '').length != 0 && jQuery('#editQR-select').val() != "" && jQuery('#editQR-select').val() != "0" && specialCharacterFlag == false) {
            this._botTrainingService.editQuickReply(this.EditQuickReplyName, jQuery('#editQR-select').val(), this.quickReplyResponseMessageId, this.quickReplyId)
                .subscribe(function (a) {
                if (a.code == 200) {
                    _this.editQuickReplyModal.close();
                    _this.blockDetail(_this.popBlock._id);
                }
            });
        }
            ...
            this.addGroupFlag = false;
            jQuery('#buttonNameEditQR').addClass('modalError');
        }
        else {
            jQuery('#editQR-select').addClass('modalError');
            jQuery('#buttonNameEditQR').addClass('modalError');
        }
    };
    Specific.prototype.editButton = function (responseMessageId, addBtnId, type, diff, gallerCardAddBtnId) {
        this.responseMessageDiff = diff;
        if (diff == 'addButton') {
            jQuery('#blockContent').css('display', 'block');
            jQuery('#quickReplyContent').css('display', 'none');
        ...
        this.gallerCardAddBtnId = gallerCardAddBtnId;
        this.editBtnResponseMessageType = type;
        this.editBtnResponseMessageId = responseMessageId;
        this.editBtnId = addBtnId;
        if (this.editBtnResponseMessageType == 'text') {
            for (var i = 0; i < this.cardArray.length; i++) {
                if (this.cardArray[i]._id == responseMessageId) {
                    for (var j = 0; j < this.cardArray[i].data.cardAddButton.length; j++) {
                        if (this.cardArray[i].data.cardAddButton[j]._addButtonId == addBtnId) {
                            this.EditButtonName = this.cardArray[i].data.cardAddButton[j].buttonname;
                            this.EditButtonBlock = this.cardArray[i].data.cardAddButton[j]._blockId;
                            jQuery('#simple-select').val(this.cardArray[i].data.cardAddButton[j]._blockId);
                            if (this.EditButtonBlock == "") {
                                this.EditButtonUrl = this.cardArray[i].data.cardAddButton[j].urlblockname;
                                //this.EditButtonBlockName = "";
                                jQuery('#blockBtn').removeClass('modalliactive');
                                jQuery('#urlBtn').addClass('modalliactive');
                                jQuery('#blockContent').removeClass('modalContentActive');
                                jQuery('#blockContent').addClass('modalContentDeActive');
                                ...
                                //this.EditButtonBlockName = this.cardArray[i].data.cardAddButton[j].urlblockname;
                                this.EditButtonUrl = "";
                                jQuery('#blockBtn').addClass('modalliactive');
                                jQuery('#urlBtn').removeClass('modalliactive');
                                jQuery('#blockContent').addClass('modalContentActive');
            ...
            for (var i = 0; i < this.cardArray.length; i++) {
                if (this.cardArray[i]._id == responseMessageId) {
                    for (var j = 0; j < this.cardArray[i].data.length; j++) {
                        if (this.cardArray[i].data[j].indexId == gallerCardAddBtnId) {
                            for (var k = 0; k < this.cardArray[i].data[j].cardAddButton.length; k++) {
                                if (this.cardArray[i].data[j].cardAddButton[k]._addButtonId == addBtnId) {
                                    this.EditButtonName = this.cardArray[i].data[j].cardAddButton[k].buttonname;
                                    this.EditButtonBlock = this.cardArray[i].data[j].cardAddButton[k]._blockId;
                                    jQuery('#simple-select').val(this.cardArray[i].data[j].cardAddButton[k]._blockId);
                                    if (this.EditButtonBlock == "") {
                                        this.EditButtonUrl = this.cardArray[i].data[j].cardAddButton[k].urlblockname;
                                        //this.EditButtonBlockName = "";
                                        jQuery('#blockBtn').addClass('modalliactive');
                                        jQuery('#urlBtn').removeClass('modalliactive');
                                        jQuery('#blockContent').addClass('modalContentActive');
                                        ...
                                        //this.EditButtonBlockName = this.cardArray[i].data[j].cardAddButton[k].urlblockname;
                                        this.EditButtonUrl = "";
                                        jQuery('#blockBtn').removeClass('modalliactive');
                                        jQuery('#urlBtn').addClass('modalliactive');
                                        jQuery('#blockContent').removeClass('modalContentActive');
    ...
    Specific.prototype.editButtonPost = function (val) {
        var _this = this;
        if (val == 1) {
            var count = 0;
            var blockname = "";
            var obj;
            for (var i = 0; i < this.select2GroupedData.length; i++) {
                if (this.select2GroupedData[i].id == this.EditButtonBlock) {
                    blockname = this.select2GroupedData[i].text;
                }
            }
            var specialCharacterFlag = false;
            if (/^[a-zA-Z0-9- ]*$/.test(this.EditButtonName) == false) {
                specialCharacterFlag = true;
            }
            if (this.editBtnResponseMessageType == 'text') {
                for (var i = 0; i < this.cardArray.length; i++) {
                    if (this.cardArray[i]._id == this.editBtnResponseMessageId) {
                        for (var j = 0; j < this.cardArray[i].data.cardAddButton.length; j++) {
                            if (this.cardArray[i].data.cardAddButton[j]._addButtonId == this.editBtnId) {
                                obj = this.cardArray[i].data.cardAddButton[j];
                                break;
                            }
                        }
                    }
                ...
                for (var i = 0; i < this.cardArray.length; i++) {
                    if (this.cardArray[i]._id == this.editBtnResponseMessageId) {
                        for (var j = 0; j < this.cardArray[i].data.length; j++) {
                            if (this.cardArray[i].data[j].indexId == this.gallerCardAddBtnId) {
                                for (var k = 0; k < this.cardArray[i].data[j].cardAddButton.length; k++) {
                                    if (this.cardArray[i].data[j].cardAddButton[k]._addButtonId == this.editBtnId) {
                                        obj = this.cardArray[i].data[j].cardAddButton[k];
                                        break;
                                    }
                                }
                            }
            ...
            if (this.EditButtonBlock != "" && this.EditButtonBlock != "0" && specialCharacterFlag == false && this.EditButtonName != "" && this.EditButtonName.replace(/\s/g, '').length != 0) {
                if (this.editBtnResponseMessageType == 'text') {
                    obj.buttonname = this.EditButtonName;
                    obj._blockId = this.EditButtonBlock;
                    obj.urlblockname = blockname;
                    jQuery('#buttonName').removeClass('modalError');
                    jQuery('#simple-select').removeClass('modalError');
                    this._botTrainingService.updateAddBtns(this.editBtnResponseMessageId, obj, 'block', this.editBtnResponseMessageType).subscribe(function (a) {
                        if (a.code == 200) {
                            _this.editAddBtnModal.close();
                            _this.AddButtonName = "";
                            _this.AddButtonBlock = "";
                            _this.blockDetail(_this.popBlock._id);
                        }
                    ...
                    jQuery('#buttonName').removeClass('modalError');
                    jQuery('#simple-select').removeClass('modalError');
                    this._botTrainingService.updateGalleryAddBtns(this.editBtnResponseMessageId, this.gallerCardAddBtnId, obj, 'block', this.gallerCardAddBtnId).subscribe(function (a) {
                        if (a.code == 200) {
                            _this.editAddBtnModal.close();
                            _this.AddButtonName = "";
                            _this.AddButtonBlock = "";
            ...
            if (this.EditButtonUrl.includes('http://') == false) {
                this.EditButtonUrl = 'http://' + this.EditButtonUrl;
            }
            if (this.editBtnResponseMessageType == 'text') {
                for (var i = 0; i < this.cardArray.length; i++) {
                    if (this.cardArray[i]._id == this.editBtnResponseMessageId) {
            ...
            if (this.EditButtonUrl != "" && this.EditButtonName != "" && this.EditButtonName.replace(/\s/g, '').length != 0 && specialCharacterFlag == false) {
                if (this.editBtnResponseMessageType == 'text') {
                    obj.buttonname = this.EditButtonName;
                    obj.urlblockname = this.EditButtonUrl;
                    jQuery('#buttonName').removeClass('modalError');
                    jQuery('#urlContentData').removeClass('modalError');
                    this._botTrainingService.updateAddBtns(this.editBtnResponseMessageId, obj, 'url', this.editBtnResponseMessageType).subscribe(function (a) {
                        if (a.code == 200) {
                            _this.editAddBtnModal.close();
                            _this.AddButtonName = "";
                            _this.AddButtonUrl = "";
                    ...
                    jQuery('#buttonName').removeClass('modalError');
                    jQuery('#simple-select').removeClass('modalError');
                    this._botTrainingService.updateGalleryAddBtns(this.editBtnResponseMessageId, this.gallerCardAddBtnId, obj, 'url', this.gallerCardAddBtnId).subscribe(function (a) {
                        if (a.code == 200) {
                            _this.editAddBtnModal.close();
                            _this.AddButtonName = "";
                            _this.AddButtonBlock = "";
    ...
    Specific.prototype.deleteGroupModal = function (Id) {
        this.deleteGroupId = Id;
    };
    Specific.prototype.deleteGroup = function () {
        var _this = this;
        this._botTrainingService.deleteGroup(this.deleteGroupId)
            .subscribe(function (a) {
            if (a.code == 200) {
                //this.populateGroups();
                for (var i = 0; i < _this.blockGroupsModel.length; i++) {
                    if (_this.blockGroupsModel[i].group._id == _this.deleteGroupId) {
                        _this.blockGroupsModel.splice(i, 1);
                        break;
                    }
                }
                _this.groupConfirmationModal.close();
            }
        });
    };
    Specific.prototype.deleteBlockModal = function (Id) {
        jQuery('.rmdiv').hide();
        this.deleteBlockId = Id;
    };
    Specific.prototype.deleteBlock = function () {
        var _this = this;
        jQuery('.rmdiv').hide();
        this._botTrainingService.deleteBlock(this.deleteBlockId)
            .subscribe(function (a) {
            if (a.code == 200) {
                for (var i = 0; i < _this.blockGroupsModel.length; i++) {
                    for (var j = 0; j < _this.blockGroupsModel[i].blocks.length; j++) {
                        if (_this.blockGroupsModel[i].blocks[j]._id == _this.deleteBlockId) {
                ...
                for (var i = 0; i < _this.select2GroupedData.length; i++) {
                    if (_this.select2GroupedData[i].id == _this.deleteBlockId) {
                        _this.select2GroupedData.splice(i, 1);
                    }
                }
                _this.blockConfirmationModal.close();
            }
        });
    };
    Specific.prototype.deleteResponseMessageModal = function (Id) {
        this.responseMessageId = Id;
    };
    Specific.prototype.deleteResponseMessage = function () {
        var _this = this;
        this._botTrainingService.deleteResponseMessage(this.responseMessageId).subscribe(function (a) {
            _this.blockDetail(_this.popBlock._id);
            ...
            _this.responseMessageConfirmationModal.close();
        });
    };
    Specific.prototype.deleteRandomText = function (Id, cardId) {
        this.randomTextId = Id;
        this.cardId = cardId;
    };
    Specific.prototype.deleteRandomTextBox = function () {
        var _this = this;
        this._botTrainingService.deleteRandomText(this.randomTextId, this.cardId).subscribe(function (a) {
            if (a.code == 200) {
                _this.blockDetail(_this.popBlock._id);
                _this.randomTextCardModal.close();
                if (a.data == true) {
                    _this.blockIsCompletedStatusChange(_this.popBlock._id, true);
                }
                else {
    ...
    Specific.prototype.delAddButton = function (addButtonId, cardId, cardType) {
        this.cardId = cardId;
        this.addButtonId = addButtonId;
        this.cardType = cardType;
    };
    Specific.prototype.deleteAddButton = function () {
        var _this = this;
        this._botTrainingService.deleteAddButton(this.addButtonId, this.cardId, this.cardType).subscribe(function (a) {
            if (a.code == 200) {
                _this.blockDetail(_this.popBlock._id);
                _this.addBtnModal.close();
            }
        });
    };
    Specific.prototype.delQuickReply = function (addButtonId, cardId) {
        this.cardId = cardId;
        this.addButtonId = addButtonId;
    };
    Specific.prototype.deleteQuickReply = function () {
        var _this = this;
        var count = 0;
        this._botTrainingService.deleteQuickReply(this.addButtonId, this.cardId).subscribe(function (a) {
            if (a.code == 200) {
                _this.blockDetail(_this.popBlock._id);
                _this.quickReplyBtnModal.close();
                for (var i = 0; i < _this.cardArray.length; i++) {
                    if (_this.cardArray[i]._id == _this.cardId) {
    ...
    Specific.prototype.delOneGalleryCard = function (cardId, galleryIndexId) {
        this.cardId = cardId;
        this.galleryIndexId = galleryIndexId;
    };
    Specific.prototype.delOneArticleCard = function (cardId, articleIndexId) {
        this.cardId = cardId;
        this.articleIndexId = articleIndexId;
    };
    Specific.prototype.deleteGalleryCardBtn = function () {
        var _this = this;
        this._botTrainingService.deleteOneGalleryCard(this.cardId, this.galleryIndexId)
            .subscribe(function (a) {
            if (a.data == true) {
                _this.blockIsCompletedStatusChange(_this.popBlock._id, true);
            }
    ...
    Specific.prototype.deleteArticleCardBtn = function () {
        var _this = this;
        this._botTrainingService.deleteOneArticleCard(this.cardId, this.articleIndexId)
            .subscribe(function (a) {
            if (a.data == true) {
                _this.blockIsCompletedStatusChange(_this.popBlock._id, true);
            }
    ...
    __decorate([
        core_1.ViewChild('responseMessageConfirmationModal'), 
        __metadata('design:type', (typeof (_d = typeof ng2_modal_1.Modal !== 'undefined' && ng2_modal_1.Modal) === 'function' && _d) || Object)
    ], Specific.prototype, "responseMessageConfirmationModal", void 0);
    __decorate([
        core_1.ViewChild('groupConfirmationModal'), 
        __metadata('design:type', (typeof (_e = typeof ng2_modal_1.Modal !== 'undefined' && ng2_modal_1.Modal) === 'function' && _e) || Object)
    ], Specific.prototype, "groupConfirmationModal", void 0);
    __decorate([
        core_1.ViewChild('blockConfirmationModal'), 
        __metadata('design:type', (typeof (_f = typeof ng2_modal_1.Modal !== 'undefined' && ng2_modal_1.Modal) === 'function' && _f) || Object)
    ], Specific.prototype, "blockConfirmationModal", void 0);
    __decorate([
        core_1.ViewChild('randomTextCardModal'), 
        __metadata('design:type', (typeof (_g = typeof ng2_modal_1.Modal !== 'undefined' && ng2_modal_1.Modal) === 'function' && _g) || Object)
    ], Specific.prototype, "randomTextCardModal", void 0);
    __decorate([
        core_1.ViewChild('addBtnModal'), 
        __metadata('design:type', (typeof (_h = typeof ng2_modal_1.Modal !== 'undefined' && ng2_modal_1.Modal) === 'function' && _h) || Object)
    ], Specific.prototype, "addBtnModal", void 0);
    __decorate([
        core_1.ViewChild('quickReplyBtnModal'), 
        __metadata('design:type', (typeof (_j = typeof ng2_modal_1.Modal !== 'undefined' && ng2_modal_1.Modal) === 'function' && _j) || Object)
    ], Specific.prototype, "quickReplyBtnModal", void 0);
    __decorate([
        core_1.ViewChild('articleIndexModal'), 
        __metadata('design:type', (typeof (_k = typeof ng2_modal_1.Modal !== 'undefined' && ng2_modal_1.Modal) === 'function' && _k) || Object)
    ], Specific.prototype, "articleIndexModal", void 0);
    __decorate([
        core_1.ViewChild('galleryIndexModal'), 
        __metadata('design:type', (typeof (_l = typeof ng2_modal_1.Modal !== 'undefined' && ng2_modal_1.Modal) === 'function' && _l) || Object)
    ], Specific.prototype, "galleryIndexModal", void 0);
    __decorate([
        core_1.ViewChild('editQuickReplyModal'), 
        __metadata('design:type', (typeof (_m = typeof ng2_modal_1.Modal !== 'undefined' && ng2_modal_1.Modal) === 'function' && _m) || Object)
    ], Specific.prototype, "editQuickReplyModal", void 0);
    __decorate([
        core_2.Input(), 
        __metadata('design:type', String)
    ...
    Specific = __decorate([
        ...
        __metadata('design:paramtypes', [(typeof (_o = typeof BotTrainingService_1.BotTrainingService !== 'undefined' && BotTrainingService_1.BotTrainingService) === 'function' && _o) || Object, (typeof (_p = typeof core_1.ElementRef !== 'undefined' && core_1.ElementRef) === 'function' && _p) || Object])
    ], Specific);
    return Specific;
...
var SpecificModule = (function () {
    function SpecificModule() {
    }
    SpecificModule.routes = exports.routes;
    SpecificModule = __decorate([
        core_1.NgModule({
            declarations: [
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.default = SpecificModule;
