...
var routes = [
    { path: '', component: layout_component_1.Layout, children: [
            ...
            { path: 'specific', loadChildren: function () { return __webpack_require__.e/* System.import */(9).then(__webpack_require__.bind(null, "./src/app/specific/specific.module.ts")).then(function (mod) { return (mod.__esModule && mod.default) ? mod.default : mod; }); } },
